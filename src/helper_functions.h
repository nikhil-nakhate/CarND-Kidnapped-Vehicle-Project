...
double multi_var_gauss(double x_obs, double y_obs,  double mu_x, double mu_y, double sig_x, double sig_y) {
...
std::pair<double , double > transform_obs(double x_part, double y_part, double theta, double x_obs, double y_obs) {
